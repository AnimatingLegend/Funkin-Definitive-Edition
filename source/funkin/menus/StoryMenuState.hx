...
class StoryMenuState extends MusicBeatState
{
	...
	override function update(elapsed:Float) 
	{
		...
		// Track difficulty selectors to selected week item.
		var selectedItem:MenuItem = weekTextGroup.members[currentWeek];
		leftArrow.y = selectedItem.y + 5;
		difficultySprites.y = leftArrow.y - 5;
