...
import funkin.util.Options.Option;
...
class ControlsSubState extends MusicBeatState
{
	...
	var keyText:Array<String> = [
		"LEFT", "DOWN", "UP", "RIGHT", "UP", "LEFT", "RIGHT", "DOWN", "RESET", "ACCEPT", "BACK", "PAUSE"
	];
	...
	override function update(elapsed:Float)
	{
		...
		if (FlxG.keys.justPressed.ANY && !FlxG.keys.justPressed.UP && !FlxG.keys.justPressed.DOWN && !FlxG.keys.justPressed.LEFT
			&& !FlxG.keys.justPressed.RIGHT)
		{
			textUpdate();
		}
