	...
	public static function initialize()
	{
		...
		**/
		...
		if (FlxG.save.data.debugDisplay == null)
			FlxG.save.data.debugDisplay = false;
		...
		if (FlxG.save.data.fpsCap > 280 || FlxG.save.data.fpsCap < 60)
			FlxG.save.data.fpsCap = 60;
		...
		if (FlxG.save.data.JudgementDisplay == null)
			FlxG.save.data.JudgementDisplay = true;
		if (FlxG.save.data.hideHUD == null)
			FlxG.save.data.hideHUD = false;
		if (FlxG.save.data.strumLineBG == null)
			FlxG.save.data.strumLineBG = 0.0;
		...
		if (FlxG.save.data.weeksUnlocked == null)
			FlxG.save.data.weeksUnlocked = 8;
		if (FlxG.save.data.resetHighscores == null)
			FlxG.save.data.resetHighscores = 0;
	}
}
