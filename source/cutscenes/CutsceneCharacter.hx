...
class CutsceneCharacter extends FlxTypedGroup<FlxSprite>
{
	...
	{
		var splitShit:Array<String> = CoolUtil.coolTextFile(Paths.file('images/cutscenes/' + imageShit + "CutsceneOffsets.txt", library));
	...
	public function createCutscene(daNum:Int = 0)
	{
		...
		cutScene.frames = Paths.getSparrowAtlas('cutscenes/' + imageShit + "-" + daNum, library);
